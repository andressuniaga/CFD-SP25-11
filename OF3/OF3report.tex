...
\subsection{Step Example}
 Considering a flow over our step at $M=3$ and $p=1$ Pa, what is the pressure at the stagnation point (x=0.6m, y=0) on the surface of the step? In effect, we are looking for the static properties past the shock. We will employ the equations laid out above.
\vspace{2mm}
...
Additionally we can calculate the total pressure past the shock using the same isentropic relation in Equation \ref{isentropic_pressure}, $p_{0_{2}} = 12.06\; \text{Pa}$.
