...
blocks
(
    hex (0 4 5 6 16 20 21 22) (48 32 1) simpleGrading (1 1 1) // block 0
    hex (6 7 1 0 22 23 17 16) (96 32 1) simpleGrading (1 1 1) // block 1
    hex (7 8 2 1 23 24 18 17) (96 32 1) simpleGrading (1 1 1) // block 2
    hex (8 9 10 2 24 25 26 18) (24 32 1) simpleGrading (1 1 1) // block 3
    hex (2 10 11 12 18 26 27 28) (24 32 1) simpleGrading (1 1 1) // block 4
    hex (12 13 3 2 28 29 19 18) (96 32 1) simpleGrading (1 1 1) // block 5
    hex (13 14 0 3 29 30 16 19) (96 32 1) simpleGrading (1 1 1) // block 6
    hex (14 15 4 0 30 31 20 16) (48 32 1) simpleGrading (1 1 1) // block 7
); \n
"""
